...
namespace FTPDownLoad
{
	public partial class Form1 : Form
	{
		...
		{
			string localPath = @"C:\Users\summer\Desktop\";
			string fileName = "MODBUS协议中文版.pdf";

			FileInfo fi = new FileInfo(localPath);
			Ftp ftp = new Ftp();
			//ftp.UploadDirectory(localPath, "ftp://192.168.0.15/", "四院报警上传文档");
			ftp.UpLoadFile(localPath+fileName, "ftp://192.168.0.15/"+fileName);
		}
	}
